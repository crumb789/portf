<template>
    <div class="icons-wrapper">
        <a  :href="linkTelegram" class="icons-item" title="contact by telegram"> 
...
export default {
    data() {
        return{
            linkTelegram: 'https://t.me/crumb789',
            linkGithub: 'https://github.com/crumb789',
        }
    },
}
</script>
